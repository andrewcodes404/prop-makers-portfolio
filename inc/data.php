...
$props[] = [
  "title" => "Italian font",
  "desc" => "Using historical references we carved polystyrene to look like old stone carving. It was coated in Idenden and gold leafed and aged with FEV’s as part of the back wall in the opera.",
...
$props[] = [
  "title" => "Tim Burton",
  "desc" => "Assisting Caitlin Murray as a textile breakdown artist working at Pinewood studios on a number of feature films inc James Bond’s Skyfall and Joe Wright’s Anna Karenina. Aging all fabric and carpets on set with distressing and painting techniques.",
...
$scenic[] = [
  "title" => "A funny thing..",
  "desc" => "We used a spray gun technique to create the texture on the walls combined with black and white illustrations and trompe l’oeil. The mosaic floor was created with sponge blocks. ",
